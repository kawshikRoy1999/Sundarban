...
export function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground pt-16 pb-24 lg:pb-12 border-t border-primary/20">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed max-w-xs">
              Experience the untamed beauty of the Sundarbans with our premium eco-tourism packages, guided by local experts.
            </p>
          ...
          {/* Quick Links */}
          <div className="flex flex-col gap-4">
            <h3 className="font-heading text-lg font-semibold text-accent">Explore</h3>
          ...
          {/* Legal */}
          <div className="flex flex-col gap-4">
            <h3 className="font-heading text-lg font-semibold text-accent">Legal</h3>
            <ul className="flex flex-col gap-3 text-sm text-primary-foreground/80">
          ...
          {/* Contact */}
          <div className="flex flex-col gap-4">
            <h3 className="font-heading text-lg font-semibold text-accent">Contact Us</h3>
            <ul className="flex flex-col gap-4 text-sm text-primary-foreground/80">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-accent shrink-0 mt-0.5" />
                <span>Godhkhali Ferry Ghat, Gosaba<br />South 24 Parganas, West Bengal 743370</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>hello@wildbengal.example.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-primary-foreground/60">
          <p>© {new Date().getFullYear()} Wild Bengal Tourism. All rights reserved.</p>
          <p>Designed for the ultimate Sundarban experience.</p>
        </div>
      </Container>
    </footer>
  );
